...
class GroqClient:
    ...
    def get_restaurant_recommendations(self, prompt: str, context: str = "", user_location: str = "") -> list[dict]:
        ...
        system_prompt = (
            ...
            "3. Nếu danh sách trống hoặc không có nhà hàng phù hợp, hãy trả về JSON: {\"message\": \"Hiện tại chưa có đầy đủ dữ liệu để đề xuất về loại món ăn này. Hãy thử tìm kiếm các loại món ăn khác.\", \"recommendations\": []}\n"
            "4. Nếu người dùng hỏi về khu vực ngoài TP.HCM, hãy trả về JSON: {\"message\": \"Hiện tại web đang không hỗ trợ khu vực bạn nhắc đến. Xin bạn hãy tìm kiếm lại.\", \"recommendations\": []}\n"
