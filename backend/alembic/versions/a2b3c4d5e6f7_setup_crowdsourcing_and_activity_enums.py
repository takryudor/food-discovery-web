"""setup_crowdsourcing_and_activity_enums (legacy revision id)

Revision ID: a2b3c4d5e6f7
Revises: 945d8f675bd4
Create Date: 2026-05-19 11:00:00.000000

Some databases were migrated when this revision used id a2b3c4d5e6f7 before the
file was renamed to a1b2c3d4e5f6. Keep this revision so Alembic can resolve
alembic_version rows that still reference a2b3c4d5e6f7.
"""
