  ...
  return (
    <div className="relative">
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        className="relative w-10 h-10 overflow-hidden rounded-full bg-gradient-to-r from-orange-500 to-red-600 flex items-center justify-center shadow-lg border-2 border-white dark:border-neutral-800"
      >
        {user.avatar ? (
          <Image
            src={user.avatar}
