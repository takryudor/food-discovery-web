          ...
          >
            ...
            >
              ...
              <div className="text-center mb-8">
                ...
                <p className="text-neutral-700 dark:text-neutral-300">{t("welcomeBack")}</p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex items-center gap-2">
                  <input
                    ...
                    disabled={isSubmitting}
                    className="w-4 h-4 rounded border-neutral-300 dark:border-neutral-700 text-orange-600 focus:ring-orange-500/50"
                  />
                  <label
                    htmlFor="remember-me"
